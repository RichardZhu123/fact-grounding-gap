...
class SimpleMultiHopQA:
    ...
    def __init__(
        ...
        self.es = Elasticsearch([f"http://{es_host}:{es_port}"], timeout=30)
        self.client = OpenAI()
    ...
    def retrieve(self, query: str) -> List[Dict]:
        """Retrieve passages from Elasticsearch."""
        es_query = {
            "size": self.retrieval_count,
        ...
        result = self.es.search(index=self.corpus_name, body=es_query)
        passages = []
