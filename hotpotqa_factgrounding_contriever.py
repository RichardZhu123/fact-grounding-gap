...
def main():
    ...
    parser.add_argument("--output", default="results/hotpotqa_factgrounding_contriever.json")
    parser.add_argument("--limit", type=int, default=None)
    parser.add_argument("--index", default="hotpotqa")
    args = parser.parse_args()

    client = OpenAI()
    retriever = ContrieverRetriever(index_path="models/contriever_hotpotqa.index", meta_path="models/contriever_hotpotqa_meta.json")
